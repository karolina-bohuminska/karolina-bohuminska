...
**Data Scientist & Researcher bridging the gap between analytics and engineering.**

I specialize in **Machine Learning**, **Signal Processing**, and **Python automation**. Currently pursuing an MSc. in Data & AI at **VŠE** after building a strong technical foundation in Bioinformatics at **CTU**.
...
*   **[Machine Learning & Recognition](https://github.com/karolina-bohuminska/Recognition-and-Machine-Learning)**
    Implementation of statistical methods (Bayes, MLE/MAP), classic algorithms (Logistic Regression, SVM, K-Means), and neural networks (Perceptron, CNN) in Python.
